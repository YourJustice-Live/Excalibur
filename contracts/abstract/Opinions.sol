...
abstract contract Opinions is IOpinions {
    ...
    function getRepForDomain(uint256 chainId, address contractAddr, uint256 tokenId, string calldata domain, DataTypes.Rating rating) public view override returns (uint256){
    ...
    function getRepForDomain(address contractAddr, uint256 tokenId, string calldata domain, DataTypes.Rating rating) public view override returns (uint256){
    ...
    function getRepForDomain(uint256 tokenId, string calldata domain, DataTypes.Rating rating) public view override returns (uint256){
    ...
    function _repAdd(address contractAddr, uint256 tokenId, string calldata domain, DataTypes.Rating rating, uint8 score) internal {
        //Update Opinion
    ...
    function _repAdd(uint256 chainId, address contractAddr, uint256 tokenId, string calldata domain, DataTypes.Rating rating, uint8 score) internal {
        //Update Opinion
